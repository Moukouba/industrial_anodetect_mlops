...
# this function is meant to create resource group
...
#python azure_components/resource_group_create.py  --subscription_id "3594a341-9a8e-498d-a0fc-ffe6e0fa4aba"  --resource_group_name rg-ml-industrial-dev   --location eastus  --tags project=industrial environment=dev department=ml
#uv run python azure_components/resource_group_create.py --subscription_id "3594a341-9a8e-498d-a0fc-ffe6e0fa4aba"  --resource_group_name rg-ml-industrial-dev   --location westeurope  --tags project=industrial environment=dev department=ml

# python azure_components/resource_group_create.py `
#   --subscription_id "3594a341-9a8e-498d-a0fc-ffe6e0fa4aba" `
...
# az group create `
#   --subscription 3594a341-9a8e-498d-a0fc-ffe6e0fa4aba `
