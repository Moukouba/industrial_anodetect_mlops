...
# uv run python azure_components/work_space_create.py --subscription_id "3594a341-9a8e-498d-a0fc-ffe6e0fa4aba" --resource_group rg-ml-industrial-dev --workspace_name aml-industrial-ws   --region westeurope